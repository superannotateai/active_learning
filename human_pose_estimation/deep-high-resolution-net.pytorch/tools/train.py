...
def parse_args():
    ...
    parser.add_argument('--prevModelDir',
                        ...
                        type=str,
                        default='')
    parser.add_argument('--use_active_learning',
                        help='If True, will turn on active learning',
                        required=False,
                        type=bool,
                        default=False)
    ...
    for cycle in progress:
        ...
        for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
            ...
            train(cfg, train_loader, model, criterion, optimizer, epoch,
                  ...
                  use_active_learning=args.use_active_learning, active_learning_lamda=0.0001,
                  cycle=cycle)

            valid_model = model
            if args.use_active_learning:
                valid_model = torch.nn.DataParallel(model.module.base_model,
                        device_ids=cfg.GPUS).cuda()
